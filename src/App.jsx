      ...
      {currentView === 'PAYMENT' && (
        <div className="glass-card" style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div className="payment-methods-grid">
            ...
            >
              <img className="payment-logo" src="https://img.icons8.com/color/96/wallet--v1.png" alt="MoMo" />
            ...
            >
              <img className="payment-logo" src="https://img.icons8.com/color/96/bank-cards.png" alt="VNPay" />
        ...
        <div className="glass-card" style={{ maxWidth: '500px', margin: '0 auto', textAlign: 'center' }}>
          <div className="payment-gateway-mockup">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', justifyContent: 'center' }}>
              <img 
                src={paymentMethod === 'MOMO' ? "https://img.icons8.com/color/96/wallet--v1.png" : "https://img.icons8.com/color/96/bank-cards.png"} 
                alt="Logo" 
                style={{ height: '32px' }} 
              />

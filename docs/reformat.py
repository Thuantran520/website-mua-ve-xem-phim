...
with open(os.path.join(docs_dir, "Bien_Ban_Hop_1.md"), "w", encoding="utf-8") as f:
    f.write(content1)
with open(os.path.join(docs_dir, "Bien_Ban_Hop_2.md"), "w", encoding="utf-8") as f:
    f.write(content2)
with open(os.path.join(docs_dir, "Bien_Ban_Hop_3.md"), "w", encoding="utf-8") as f:
    f.write(content3)
with open(os.path.join(docs_dir, "Bien_Ban_Hop_4.md"), "w", encoding="utf-8") as f:
    f.write(content4)

print("Formatted Bien_Ban_Hop 1 to 4")
